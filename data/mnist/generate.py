"""=============================================================================
Script to generate MNIST dataset with summary statistic pairs.
============================================================================="""
...
def main(cfg):
    ...
    images = train_set.train_data.numpy()
    ...
    while len(images):
        ...
        for i, (img, lab) in enumerate(zip(images, labels)):
            ...
            # along with gene-specific correlations that are noise for the
    ...
    for i in range(64):
        ...
        img = img.unsqueeze(0)
        examples[i] = img
    save_image(examples, 'examples.png')

    torch.save({
        'images': images_new,
        'labels': labels_new,
        'genes':  genes_new
    }, '%s/train2.pth' % cfg.ROOT_DIR)
